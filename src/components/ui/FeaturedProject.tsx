import type { FeaturedProject as FeaturedProjectType } from "../../data/content";
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <motion.span
          className="featured-project__overlay"
          variants={{
            rest: { opacity: 0 },
            hover: {
      ...
      <motion.div
        ...
        animate={{
          borderLeftColor: hovered ? "var(--border-hover)" : "var(--border)",
        }}
        transition={{
